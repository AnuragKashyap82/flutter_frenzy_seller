...
class UpdateProductAllImages extends StatefulWidget {
  final snap;
  const UpdateProductAllImages({Key? key, required this.snap}) : super(key: key);

  @override
  State<UpdateProductAllImages> createState() => _UpdateProductAllImagesState();
}

class _UpdateProductAllImagesState extends State<UpdateProductAllImages> {
  Uint8List? banneer1;
  Uint8List? banneer2;
  Uint8List? banneer3;
  Uint8List? banneer4;
  ...
  void initState() {
    ...
    super.initState();
    banner1Url = widget.snap['banner1'];
    banner2Url = widget.snap['banner2'];
    banner3Url = widget.snap['banner3'];
    banner4Url = widget.snap['banner4'];
    banner5Url = widget.snap['banner5'];
    banner6Url = widget.snap['banner6'];
  }
            ...
            children: [
              ...
              Container(
                ...
                child: banneer1 != null
                    ...
                    : Image.network(widget.snap['banner1']),
              ),
              SizedBox(
                height: 8,
              ),
              ...
              Container(
                ...
                child: banneer2 != null
                    ...
                    : Image.network(widget.snap['banner2']),
              ),
              SizedBox(
                height: 8,
              ),
              ...
              Container(
                ...
                child: banneer3 != null
                    ...
                    : Image.network(widget.snap['banner3']),
              ),
              SizedBox(
                height: 8,
              ),
              ...
              Container(
                ...
                child: banneer4 != null
                    ...
                    : Image.network(widget.snap['banner4']),
              ),
              SizedBox(
                height: 8,
              ),
              ...
              Container(
                ...
                child: banneer5 != null
                    ...
                    : Image.network(widget.snap['banner5']),
              ),
              SizedBox(
                height: 8,
              ),
              ...
              Container(
                ...
                child: banneer6 != null
                    ...
                    : Image.network(widget.snap['banner6']),
              ),
              SizedBox(
                height: 8,
              ),
